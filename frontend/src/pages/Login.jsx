  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        flexDirection: isMobile ? "column" : "row"  // ✅ mobile mein column
      }}>

        {/* Left panel — mobile mein chhota */}
        {!isMobile && (
          <div style={{
            flex: 1,
            ...
            <div>
              <h2 style={{ fontSize: "32px", fontWeight: "800", margin: "0 0 14px", letterSpacing: "-0.5px" }}>Smart EV<br />Charging Network</h2>
              <p style={{ fontSize: "14px", opacity: 0.85, lineHeight: 1.6, margin: 0 }}>Monitor chargers, track sessions, manage revenue — all from one powerful dashboard.</p>
        ...
        {isMobile && (
          <div style={{
            ...
            <div style={{ width: "36px", height: "36px", borderRadius: "10px", background: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px" }}>⚡</div>
            <span style={{ fontWeight: "800", fontSize: "16px" }}>EV CHARGING</span>
          </div>
        )}
        ...
        <div style={{
          ...
          <input type="email" placeholder="admin@evcharging.com" value={email}
