...
export default function Chargers() {
  ...
  const [showForm, setShowForm] = useState(false)        // ✅ add kiya
  const [form, setForm] = useState({                     // ✅ add kiya
    name: "", location: "", latitude: "", longitude: "",
    availableSlots: "", totalSlots: "", pricePerHour: "",
    chargerType: "Fast"
  })
        ...
        <main style={{ flex: 1, padding: "28px" }}>
          ...
          {showForm && (
            <div style={{
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e => setForm(prev => ({ ...prev, chargerType: e.target.value }))}
                    style={{
                      width: "100%", padding: "10px 14px", borderRadius: "8px",
                      border: "1px solid #e2e8f0", fontSize: "13px",
              ...
              <button onClick={handleAddStation} style={{
